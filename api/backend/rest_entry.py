...
def create_app():
    ...
    app.register_blueprint(coopPositions, url_prefix='/api')
    app.register_blueprint(companyProfiles, url_prefix='/api')
    app.register_blueprint(workedatpos, url_prefix='/api')
    app.register_blueprint(views_position, url_prefix='/api')
    app.register_blueprint(applications, url_prefix='/api')
    app.register_blueprint(advisoradvisee, url_prefix='/api')
